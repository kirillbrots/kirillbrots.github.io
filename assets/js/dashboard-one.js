$(function(){
  ...
  var ctxData1 = [5, 5, 5, 5, 5, 6, 7, 5, 5, 5, 5, 4];
  var ctxData2 = [1, 0, 0, 0, 0, 5, 5, 5, 3, 2, 5, 2];
  ...
  var fcData1 = [[0,10],[1,8],[2,5],[3,4],[4,3],[5,2],[6,1],[7,11],[8,5],[9,4],[10,17],[11,17],[12,17],[13,17],[14,17],[15,17],[16,17],[17,17],[18,17],[19,17],[20,17],[21,17],[22,17],[23,17],[24,17],[25,17],[26,8],[27,10],[28,9],[29,8],[30,5]];

  var fcData2 = [[0,.3],[1,.3],[2,.3],[3,.3],[4,.3],[5,.3],[55,.3],[7,.3],[8,.3],[9,.3],[10,.3],[11,.3],[12,.3],[28,.3],[14,.3],[15,.3],[34,.3],[17,.3],[90,.3],[19,.3],[20,.3],[21,.4],[22,.4],[23,.4],[24,.4],[25,.4],[26,.4],[27,.4],[28,.4],[29,.4],[30,.4]];
  ...
  $.plot('#flotChart2', [{
    ...
    data: [[0,40],[1,40],[2,50],[3,20],[4,30],[5,30],[6,20],[7,50],[8,10]],
    color: '#ededfd'
  }], {
    series: {
      stack: 0,
